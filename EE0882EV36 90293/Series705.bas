...
'Display Constants
Public Const NUMROWSSCANRESULTSDISPLAY = 46     'Maximum number of rows in the Scan Results display
Public Const NUMROWSSCANSTATSDISPLAY = 34       'Maximum number of rows in the Scan Stats display
...
If gblnGraphEnable Then
    ...
    lstrTitle(0) = "Forward": lstrTitle(1) = "Reverse"
    Call LoadGraphArray(-1, 2, "Force", lstrTitle(), "Position (°)", "Force (Newtons)", gudtMachine.xAxisLow, gudtMachine.xAxisHigh, 50, 0, gudtTest(CHAN0).evaluate.start, gudtTest(CHAN0).evaluate.stop, lsngIncrement, lstrGraphFooterhigh, lstrGraphFooterLow, gsngMultipleGraphArray(), msngMaxForceGradientLimit(), msngMinForceGradientLimit())
...
gstrINIFile = lstrParFileTable(lintRow, lintColumn): lintRow = lintRow + 1
 
lintColumn = 1   'row & column start locations
gudtSolver(1).OSYS1(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1
gudtSolver(2).OSYS1(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1
lintRow = lintRow + 1: lintColumn = 1   'row & column start locations
gudtSolver(1).OSYS2(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1
gudtSolver(2).OSYS2(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1
lintRow = lintRow + 1: lintColumn = 1   'row & column start locations
gudtSolver(1).OSYS3(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1
gudtSolver(2).OSYS3(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1
lintRow = lintRow + 1: lintColumn = 1   'row & column start locations
gudtSolver(1).OSYS5(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1
gudtSolver(2).OSYS5(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1
lintRow = lintRow + 1: lintColumn = 1   'row & column start locations
gudtSolver(1).OSYS6(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1
gudtSolver(2).OSYS6(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1
lintRow = lintRow + 1: lintColumn = 1   'row & column start locations
gudtSolver(1).OSYS7(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1
gudtSolver(2).OSYS7(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1

lintRow = lintRow + 1: lintColumn = 1   'row & column start locations
gudtSolver(1).SSYS1(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1
gudtSolver(2).SSYS1(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1
lintRow = lintRow + 1: lintColumn = 1   'row & column start locations
gudtSolver(1).SSYS2(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1
gudtSolver(2).SSYS2(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1
lintRow = lintRow + 1: lintColumn = 1   'row & column start locations
gudtSolver(1).SSYS3(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1
gudtSolver(2).SSYS3(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1
lintRow = lintRow + 1: lintColumn = 1   'row & column start locations
gudtSolver(1).SSYS5(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1
gudtSolver(2).SSYS5(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1
lintRow = lintRow + 1: lintColumn = 1   'row & column start locations
gudtSolver(1).SSYS6(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1
gudtSolver(2).SSYS6(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1
lintRow = lintRow + 1: lintColumn = 1   'row & column start locations
gudtSolver(1).SSYS7(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1
gudtSolver(2).SSYS7(1) = Val(lstrParFileTable(lintRow, lintColumn)): lintColumn = lintColumn + 1
