...
Begin VB.Form frmPrintPreview2 
   ...
   End
End
Attribute VB_Name = "frmPrintPreview2"
...
flexGrid(5).RowHeight(0) = 250
flexGrid(5).ColAlignment(0) = flexAlignLeftCenter
flexGrid(5).TextMatrix(0, 0) = frmMain.Caption
flexGrid(5).GridLines = flexGridNone
flexGrid(5).GridColor = vbWhite
flexGrid(5).BorderStyle = flexBorderNone
