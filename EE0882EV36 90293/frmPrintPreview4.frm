...
Begin VB.Form frmPrintPreview4 
   ...
   End
End
Attribute VB_Name = "frmPrintPreview4"
...
flexGrid(8).Rows = 2
flexGrid(8).Cols = 4
flexGrid(8).RowHeight(0) = 375
flexGrid(8).RowHeight(1) = 375
flexGrid(8).ColWidth(0) = 1900: flexGrid(8).ColWidth(1) = 1850
flexGrid(8).ColWidth(2) = 1850: flexGrid(8).ColWidth(3) = 1900
flexGrid(8).TextMatrix(0, 0) = "Customer"
flexGrid(8).TextMatrix(1, 0) = ""
flexGrid(8).TextMatrix(0, 1) = "Customer Part #"
flexGrid(8).TextMatrix(1, 1) = ""
flexGrid(8).TextMatrix(0, 2) = "CTS Part #"
flexGrid(8).TextMatrix(1, 2) = ""
flexGrid(8).TextMatrix(0, 3) = "Part Name"
flexGrid(8).TextMatrix(1, 3) = ""
flexGrid(8).GridLines = flexGridNone
flexGrid(8).GridColor = vbWhite
flexGrid(8).BorderStyle = flexBorderNone

flexGrid(8).Row = 0
For k = 0 To flexGrid(8).Cols - 1
    flexGrid(8).Col = k
    flexGrid(8).CellAlignment = flexAlignCenterCenter
Next k
